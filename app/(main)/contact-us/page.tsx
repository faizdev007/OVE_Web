    ...
    if(loading) return (
        <>
            <div className=''>
                ...
                <main className="bg-black/90 pt-20 h-full dark:bg-gray-800 text-white grid lg:grid-cols-2 gap-8 lg:px-4 px-2 py-12 animate-pulse">
                    {/* Left Panel */}
    ...
    return (
        <>
            <div className=''>
                ...
                <main className="bg-black/90 pt-20 dark:bg-gray-800 text-white grid lg:grid-cols-2 gap-8 lg:px-4 px-2 py-12">
                ...
                <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: "easeOut" }} viewport={{ once: true }} className="relative py-12">
                    ...
                    <section className='pb-12 dark:py-12'>
                        <div className='text-center'>
