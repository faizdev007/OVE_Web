...
const VACTA2 = (CTA2:any) => {
    ...
    return(
        ...
        <>   
            <section className="text-black py-12 dark:py-12 dark:text-white flex flex-col items-center relative px-4 sm:px-6 lg:px-8 mx-auto">
                <div className="w-full flex flex-col items-center dark:bg-gray-600 p-8 rounded-3xl gap-6 bg-oveblue/10 border mx-auto">
