            ...
            <section className="text-black dark:text-white py-12 dark:py-12 flex flex-col items-center relative px-4 sm:px-6 lg:px-8 mx-auto">
                <div className="w-full flex flex-col items-center p-8 rounded-3xl gap-6 bg-oveblue/10 dark:bg-gray-700 border mx-auto">
                    ...
                    <div className="flex gap-3 items-center">
                        <button type="button" onClick={() => setIsOpen(true)} aria-label="contact" className="rounded-full text-white cursor-pointer flex items-center gap-2 bg-oveblue px-4 py-2 hover:bg-gray-700 dark:hover:bg-black"><span dangerouslySetInnerHTML={{ __html: CTA2?.CTA2?.buttonText ?? 'Start Saving Time. Get a Assistant'}}/>
