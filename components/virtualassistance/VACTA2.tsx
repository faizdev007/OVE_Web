            ...
            <section className="text-black py-12 dark:py-12 flex flex-col items-center relative px-4 sm:px-6 lg:px-8 mx-auto">
                <div className="w-full flex flex-col items-center p-8 rounded-3xl gap-6 bg-oveblue/30 border mx-auto">
                    ...
                    <div className="flex gap-3 items-center">
                        <button type="button" onClick={() => setIsOpen(true)} aria-label="contact" className="rounded-full border-3 text-white flex items-center gap-2 border-black bg-gray-900 px-4 py-2 hover:bg-gray-700"><span dangerouslySetInnerHTML={{ __html: CTA2?.CTA2?.buttonText ?? 'Start Saving Time. Get a Assistant'}}/>
