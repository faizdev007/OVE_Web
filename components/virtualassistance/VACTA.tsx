        ...
        <>   
            <section className="text-white bg-oveblue/80 py-12 dark:py-12 flex flex-col items-center gap-6 relative px-4 sm:px-6 lg:px-8 mx-auto">
                ...
                <div className="flex gap-3 items-center">
                    <button type="button" onClick={() => setIsOpen(true)} aria-label="contact" className="rounded-md border-3 cursor-pointer flex items-center gap-2 border-black bg-gray-900 px-4 py-2 hover:bg-gray-700"><span dangerouslySetInnerHTML={{ __html: CTA?.CTA?.buttonText ?? 'Book A Free Consultation Now'}}/>
