...
export default function ImageSteps(StepsBlock:any) {
  ...
  return (
    <section className="py-12 dark:py-12 flex dark:bg-gray-700 flex-col gap-6 relative px-4 sm:px-6 lg:px-8 mx-auto">
        {/* Main Header */}
            ...
            <div className="md:w-1/2 flex items-center">
                <div className="w-full space-y-4">
                    ...
                    return (
                        <div
                            key={index}
                            className={`border-oveblue dark:bg-gray-600 rounded py-2 px-4 shadow-sm shadow-oveblue transition-all cursor-pointer ${open ? "border-b-4" : ""}`}
                            onClick={() => {
                                toggle(index);
