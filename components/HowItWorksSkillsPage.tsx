  ...
  return (
    <main className="bg-black text-white">
      <div className="mx-auto max-w-6xl px-4 py-10 md:py-14">
        {/* Top intro block */}
        <section className="grid grid-cols-1 sm:grid-cols-[250px_1fr] justify-center gap-5 items-start">
          {/* Avatar */}
        ...
        {/* Big heading */}
        <h3 className="mt-12 md:mt-16 text-xl md:text-2xl font-extrabold uppercase tracking-wide">
