    ...
    <>
        <motion.section initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: "easeOut" }} viewport={{ once: true }}  className="relative dark:bg-gray-900 pb-12 dark:py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className='w-full flex justify-center mt-10'>  
                <a href={'/contact-us'} className='md:w-1/3 w-1/2 cursor-pointer text-center capitalize hover:bg-btnblue/90 drop-shadow shadow hover:shadow-xl bg-btnblue text-white lg:p-3 p-2 xl:text-3xl text-nowarp font-bold rounded'>{hiringprocessdata?.ctaTitle ?? 'Hire a talent'}</a>
            </div>
        </motion.section>
    </>
    );
