        ...
        <motion.section initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: "easeOut" }} viewport={{ once: true }}  className="bglbLG dark:bg-gray-800 headingtext relative px-4 py-12 sm:px-6 lg:px-8 mx-auto flex flex-col gap-10">
                    ...
                    {RoleCards?.map((role, i) => (
                        <a href={role.slug} key={i} className="cardLG hover:bg-carblue/50 rounded shadow-md hover:shadow-lg">
                            <div className='flex flex-col p-6 text-center justify-center items-center gap-4'>
                                ...
                                <h2 className='capitalize text-white font-bold'>{role.name}</h2>
                            </div>
                        </a>
                    ))}
            ...
            <div className='container mx-auto'> 
                ...
                <div className="gap-4 grid grid-cols-2 lg:grid-cols-5 md:grid-cols-3 md:text-sm space-2 text-xs">
                    ...
                    <div key='action2' className="cardLG rounded shadow-md">
                        <div className='flex flex-col p-6 text-center justify-center items-center gap-4'>
                            <h2 className='font-bold uppercase text-white'>Looking for Other Skill?</h2>
                            <a href='/contact-us' className='border-2 border-white text-white hover:bg-carblue/50 hover:text-white font-bold md:text-lg text-sm rounded px-2 py-1 cursor-pointer'>Place Request</a>
                        </div>
                    </div>
                </div>
