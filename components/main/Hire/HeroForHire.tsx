...
const HeroForHire = ({hire}:any) => {
    return (
    <>
        <section className="hiredefault py-20 py-6 lg:flex gap-2 dark:bg-gray-800 text-white relative px-4 sm:px-6 lg:px-8 mx-auto">
            <div className="flex lg:w-[60%] flex-col h-full justify-center gap-10 items-center md:items-start py-6">
